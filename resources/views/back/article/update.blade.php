    ...
    <div class="mt-3">
        ...
        <form action="{{ url('article/'.$article->id) }}" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <textarea name="desc" id="myEditor" cols="30" rows="10" class="form-control ckeditor">{!!  $article->desc !!}</textarea>
            </div>
            ...
            <div class="mb-3">
                ...
                <div class="mt-1">
                    ...
                    <img src="{{ asset('storage/back/' . $article->img) }}" alt="" width="150px">
                </div>
            </div>
            ...
            <div class="float-end">
                ...
                <a href="{{ url('article') }}" class="btn btn-sm btn-secondary">Kembali</a>
            </div>
        </form>
    </div>
</main>
